...
│
├── pyproject.toml     <- Project configuration file with package metadata for cognifyztech_intern
...
│
└── cognifyztech_intern                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes cognifyztech_intern a Python module
    │
